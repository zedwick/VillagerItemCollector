...
schedule function villager_item_collector:check_all_villagers 2t
...
execute unless entity @e[type=villager,tag=!vic_done] run function villager_item_collector:reset_and_wait
